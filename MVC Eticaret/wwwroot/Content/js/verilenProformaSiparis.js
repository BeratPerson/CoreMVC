...
window.onload = function () {
    ...
    console.log($('#ProformaSiparisTable_info'));
};
function Kaydet() {
    var sorun = 0;
    ...
    if (sorun == 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: '/ProformaSiparis/YeniVerilenProformaSiparisOlustur',
                ...
                if (data.status === 'False') {
                    ...
                    if (valdata == "") {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            type: 'POST',
                            url: '/ProformaSiparis/YeniVerilenProformaSiparisOlusturUser',
                            data: valdata,
                            success: function (data) {
                                if (data.status === 'False') {
                                    $('#BasarisizKayit').show();
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '/ProformaSiparis/YeniVerilenProformaSiparisOlusturFile',
                                        dataType: "json",
                                        contentType: false,
                                        processData: false,
                                        data: fileData,
